    ...
    return (
        <div>
            ...
            <div>
                ...
                <p class="paragraph">College is located in the midst of Multimodal International Cargo Hub and Airport (MIHAN) and also in the vicinity of Butibori Industrial area, Nagpur.</p>
                <p class="paragraph">This sanstha is started by the dedicated and renowned academicians genuinely committed to impart quality technical education to the students, who are aspiring for carrier in Engineering, Technology and Management.</p>
                <p class="paragraph">College offers additional courses beyond syllabus to expose the students towards the industrial climate by conducting courses in C++ with PYTHON, C#.NET, Java, Oracle-SQL and Administration, CCNA, PLC SCADA, MATLAB, AUTOCAD, STAAD PRO, CREO, PHP.</p>
                <p class="paragraph">The college has signed MoU with Charusat University, Gujrat Dr. Panjabrao Deshmukh Krishi Vidyapeeth (PDKV), Akola and Vignan’s University, Guntur to excel the academic and research capability of staff and students in the emerging fields of Science, Engineering and Agriculture.</p>
                <p class="paragraph">The staff having versatile rich experience in teaching, research and industry are educating students of all sections of society to foster Quality Education and to build high moral standards.</p>
                <p class="paragraph">TGPCET develops the attitude towards equality, fraternity, liberty, justice and respect for all sections of society. TGPCET grows students in the domain of latest scientific and technological areas by introducing ATMEL, USA, ROBOTICS and embedded programs for enhancing inter disciplinary research fields.</p>
                <p class="paragraph">College has continuously risen in popularity amongst the aspiring students and parents and has become a preferred choice for taking admissions due to availability of elegant and vast infrastructure facilities, dedicated staff members, who provides holistic quality education.</p>
                <p class="paragraph">The college is guided by its Advisory Committee consisting of Eminent Academician from Prestigious Institutes and also by the Renowned Industrialists. The institute works towards excellence in imparting quality technical education by motivating students to become a trend-setter to acquire Global leadership. For implementing the quality policy, an action plan is collectively prepared by the Principal and HoDs as per the vision of the Management and the Management regularly interacts with the Principal to review the implementation process of the quality plans.</p>
                <p class="paragraph">ABP News had honored with an Award to TGPCET as “An Outstanding Institute (West)” in the year 2015. It also got feather in the cap in Academics by getting an Award from Big Research as “A Most Promising Engineering College” in the Vidarbha Region of Maharashtra in the year 2012.</p>
            </div>
        </div>
    )
}
